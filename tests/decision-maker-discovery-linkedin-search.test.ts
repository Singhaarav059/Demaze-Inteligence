...
// ============================================================
// lib/enrichment/discovery-engine.ts's searchTavily is mocked entirely, same
// precedent as tests/decision-maker-discovery-prospeo.test.ts, so these test
// query building, result filtering, and title-match confidence without a
// real network/search-API call.
// ============================================================
...
beforeEach(() => {
  vi.clearAllMocks()
  process.env = { ...ORIGINAL_ENV, TAVILY_API_KEY: 'tavily-key' }
})
